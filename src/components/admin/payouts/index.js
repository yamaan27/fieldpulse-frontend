  ...
  return (
    <>
      <Grid item xs={12} style={{ width: "100%" }} pb={0}>
        <TitleWrapper style={{ paddingBottom: "0" }} title="Payouts" />
      </Grid>
      <BoxWrapper>
        <ImageWrap>
...
PayoutsComp.propTypes = {};

PayoutsComp.defaultProps = {};

export const Payouts = connect(null, mapDispatchToProps)(PayoutsComp);
