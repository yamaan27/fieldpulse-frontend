...
const OngoingTaskDetailsComp = (props) => {
  ...
  const handleSaveEdit = () => {
    ...
    const body = {
      ...
      status: "completed",
      proof: {
        notes: values?.proof?.notes || "", // pull the note value safely
      },
    };
    let query = {
      id: id,
  ...
  const handleNoteChange = (event) => {
    ...
    setValues((prevValues) => ({
      ...prevValues,
      proof: {
        ...(prevValues.proof || {}), // keep existing proof structure if it exists
        notes: value,
      },
    }));
  };
            ...
            {!isSmallScreen && (
              <Grid item sx={12} md={6}>
                <ButtonContainer
                  ...
                  labelRight={isEditMode ? "Save" : "Complete Task"}
                ...
                <CardWrapper>
                  ...
                  <Grid container spacing={2}>
                    ...
                    >
                      <FormControl fullWidth>
                        <CustomFormLabel>
                          Describe what you have done <Asterisk />
                        </CustomFormLabel>
...
OngoingTaskDetailsComp.propTypes = {
...
OngoingTaskDetailsComp.defaultProps = {}

export const OngoingTaskDetails = connect(
  null,
  mapDispatchToProps
)(OngoingTaskDetailsComp)
